...
const viewAll = async (req, res) => {
  ...
  if (!album) {
    return res
      ...
      .json({ success: false, msg: "can not find the required album" });
  }
  res
    .status(StatusCodes.OK)
    .json({ success: true, album, nbhits: album.length });
};
...
const create = async (req, res) => {
  ...
  if (!album) {
    return res
      ...
      .json({ success: false, msg: "can not create album" });
  }
  res
    .status(StatusCodes.CREATED)
    .json({ msg: "created successfully", _id: album._id, album });
};
const update = async (req, res) => {
  ...
  if (!album) {
    return res
      .status(StatusCodes.BAD_REQUEST)
      .json({ success: false, msg: "can not update album" });
  }
...
const deleteOne = async (req, res) => {
  ...
  if (!album) {
    return res
      .status(StatusCodes.BAD_REQUEST)
      .json({ success: false, msg: "can not delete album" });
  }
